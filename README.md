...
A YOLOv2-based object detection model aimed on Akida 1000 neuromorphic processor using TensorFlow/Keras and BrainChip's MetaTF framework. This model is work in progress.
## Overview
